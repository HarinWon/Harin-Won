...
// 객체 선언 시, key 네이밍 === value값으로 할당하고자 하는 매개변수의 이름이 동일한 상황이 펼쳐졌을 때에는 한번만 써도(축약해도) 돌아감
...
const fruts02 = ["사과", "복숭아"];

// const apple = fruts02[0];
// const peach = fruts02[1];

const [apple, peach] = fruts02;
